        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La Unidad 3 del curso de Derecho Constitucional I, estudia la estructura orgánica del Estado colombiano, abordando sus tres ramas del poder público (Legislativa, Ejecutiva y Judicial) y los órganos de control como el Ministerio Público y la Contraloría. Se analizan sus funciones, relaciones y principios constitucionales que rigen su actuar. Además, se incluyen órganos autónomos con funciones técnicas y regulatorias. El objetivo es formar juristas capaces de interpretar la organización del Estado, comprender el control institucional y proponer soluciones basadas en la Constitución y la legalidad democrática.
